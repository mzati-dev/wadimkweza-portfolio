      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Looking to build production-ready AI systems, scale ML pipelines, or integrate advanced LLMs? Let's discuss your infrastructure and modeling needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-8">
              <h4 className="text-lg font-semibold text-white mb-4">Follow My Research & Code</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Tell me about your project, data infrastructure, or the AI solutions you want to deploy..."
                    required
                  />
                </div>
