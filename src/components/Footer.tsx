        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              AI Engineer architecting scalable machine learning infrastructure, integrating advanced LLMs, and deploying robust AI systems to production.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['AI System Architecture', 'Generative AI & LLMs', 'MLOps & Deployment', 'Data Engineering'].map((service) => (
                <li key={service}>
